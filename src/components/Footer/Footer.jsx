  ...
  return (
    <Row>
        <Col md={3} className="mb-4 my-md-0">
            <div className={`subtitle ${style.subtitle}`}>Jalan Suroyo No. 161 Mayangan Kota Probolonggo 672000</div>
            <div className={`subtitle ${style.subtitle} my-3`}>binarcarrental@gmail.com</div>
        ...
        <Col md={3} className="mb-4 my-md-0">
            ...
            <ul className={style.listMedsos}>
                <li><img src={icon_facebook} /></li>
                <li><img src={icon_instagram} /></li>
                <li><img src={icon_mail} /></li>
                <li><img src={icon_twitch} /></li>
                <li><img src={icon_twitter} /></li>
            </ul>
        </Col>
        <Col md={3}>

    ...
    <Row>
        ...
        <Col md={6}>
            <Accordion defaultActiveKey="0" flush>
                <Accordion.Item eventKey="1" className="my-4 border">
                ...
                <Accordion.Item eventKey="2" className="my-4 border">
                ...
                <Accordion.Item eventKey="3" className="my-4 border">
                ...
                <Accordion.Item eventKey="4" className="my-4 border">
                ...
                <Accordion.Item eventKey="5" className="my-4 border">
